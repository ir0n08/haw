...
public class CharacterTest {
    @Test public void testConstructor() {
      ...
      assertEquals(jamie.isAlive(), true);
    ...
    public void testConstructor_toLowFightSkills() {
      House lannister = new House("Lannister", "Casterly Rock");
      Character jamie = new Character("", lannister, true, -1);
    }

    @Test(expected = IllegalArgumentException.class) 
    public void testConstructor_toLargeFightSkills() {
      House lannister = new House("Lannister", "Casterly Rock");
      Character jamie = new Character("", lannister, true, 124);
    }
    ...
    @Test public void testFight(){
      ...
      assertFalse(redShirtKnight.isAlive());
      assertTrue(hound.isAlive());
    }
